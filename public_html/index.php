				...
				<div class="row row-flex">
					...
					<div class="col-sm-6 col-md-8">
						<div>
							...
							<p class="lead m-a-0">There are also some goodies in the CSS as well, tons of custom styles, equal height columns using flexbox, two layouts (home and content pages), a contact form, custom JavaScript, and more. <em class="text-serif">View Source!</em> <i class="fa fa-magic"></i></p>
						</div>
					</div>
				</div>
			</div>
